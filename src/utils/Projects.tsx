    ...
    <div className="py-5">
      <div className="row mb-5">
        <div className="col-12 text-center">
          <h2 className="display-5 fw-bold text-white">Projects</h2>
      ...
      <div className="d-flex flex-column gap-5">
        {projects.map((project) => {
          ...
          return (
            <div
              key={project.id}
              className={`row ${isEven ? "justify-content-end" : "justify-content-start"}`}
            >
              <div className="col-12 col-md-6 col-lg-5">
                <SpotlightCard
                  className="custom-spotlight-card d-flex flex-column w-100"
                  style={{ minHeight: "220px" }}
                  spotlightColor="rgba(58, 10, 140, 0.8)"
                >
                  {/* top logo */}
                  <img
                    src={project.image}
                  ...
                  {/* title */}
                  <div className="h5 fw-bold text-white mb-2">
                    {project.title}
                  </div>
